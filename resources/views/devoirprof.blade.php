        ...
        <section class="py-5">
            <div class="container px-5 mb-5">
                <div class="text-center mb-5">
                    <h1 class="display-5 fw-bolder mb-0"><span class="text-gradient d-inline">Partage des devoirs</span></h1>
                </div>
                ...
                <form action="{{ route('devoir.upload') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <section class="py-5 bg-gradient-primary-to-secondary text-white">
            <div class="container px-5 my-5">
                <div class="text-center">
                    <h2 class="display-4 fw-bolder mb-4">Si vous trouvez un problème</h2>
                    <a class="btn btn-outline-light btn-lg px-5 py-3 fs-6 fw-bolder" href="/problems/create">Contact me</a>
                </div>
            </div>
        </section>
    </main>
